...
export default function Sidebar(){
    ...
    return (
        <div className='h-screen pt-10 w-[17%] fixed shadow-xl hi text-white' >
            <div className='flex pl-8  space-x-2'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 mt-1 rounded-full"><path fillRule="evenodd" d="M2.25 4.125c0-1.036.84-1.875 1.875-1.875h5.25c1.036 0 1.875.84 1.875 1.875V17.25a4.5 4.5 0 11-9 0V4.125zm4.5 14.25a1.125 1.125 0 100-2.25 1.125 1.125 0 000 2.25z" clipRule="evenodd" /><path d="M10.719 21.75h9.156c1.036 0 1.875-.84 1.875-1.875v-5.25c0-1.036-.84-1.875-1.875-1.875h-.14l-8.742 8.743c-.09.089-.18.175-.274.257zM12.738 17.625l6.474-6.474a1.875 1.875 0 000-2.651L15.5 4.787a1.875 1.875 0 00-2.651 0l-.1.099V17.25c0 .126-.003.251-.01.375z" /></svg>
                <h1 className='text-3xl font-semibold '> Cofeed </h1>
            </div>
            <div className='mt-10 scale-95 '>
                <h2 className='pl-8 text-gray-500 font-bold text-xl mb-7'> MENU </h2>
                <ul className='flex flex-col text-white mb-10'>
                    <Link to='../home'>
                        <li className='flex space-x-4 hover:text-purple-500 hover:bg-indigo-200 py-4 px-2'>
                    ...
                    <li className='flex space-x-4 hover:text-purple-500 hover:bg-indigo-200 py-4 px-2' onClick={() => setModalOpened(true)}>
                        <span className='ml-10 mr-5'>  
                    ...
                    <li className='flex space-x-4 hover:text-purple-500 hover:bg-indigo-200 py-4 px-2 'onClick={handleLogOut}>
                        <span className='ml-10 mr-5'>
